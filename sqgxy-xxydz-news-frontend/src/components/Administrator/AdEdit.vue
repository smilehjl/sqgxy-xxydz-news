  ...
  <div>
    ...
    <el-dialog title='修改普通管理员密码' :visible.sync='editDialogVisible' width='50%' @close='editClose'>
      ...
      <el-form ref='editFormRef' :model='editForm' label-width='80px' status-icon>
        <el-form-item label='用户名:'>
          <el-input v-model='editForm.username' prefix-icon='iconfont icon-user' placeholder='请输入账号'
                    clearable=''></el-input>
        </el-form-item>
        <el-form-item label='旧密码:'>
          <el-input v-model='editForm.oldPassword' prefix-icon='iconfont icon-3702mima' type='password' show-password
                    placeholder='请输入旧密码'></el-input>
        </el-form-item>
        <el-form-item label='新密码:'>
          <el-input v-model='editForm.password' prefix-icon='iconfont icon-3702mima' type='password' show-password
    ...
    <el-dialog title='添加普通管理员' :visible.sync='addDialogVisible' width='50%' @close='addClose'>
      ...
      <el-form ref='addFormRef' :model='addForm' label-width='80px' status-icon>
        <el-form-item label='用户名:'>
          <el-input v-model='addForm.username' prefix-icon='iconfont icon-user' placeholder='请输入账号'
                    clearable=''></el-input>
        </el-form-item>
        <el-form-item label='密码:'>
          <el-input v-model='addForm.password' prefix-icon='iconfont icon-3702mima' type='password' show-password
